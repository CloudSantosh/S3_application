...
#---------------------------------------------------------------------
# Define public acl info
#---------------------------------------------------------------------
/*
resource "aws_s3_bucket_acl" "secure_bucket_acl_1" {
  bucket = aws_s3_bucket.mybucket_1.id
  acl    = "private"
}

resource "aws_s3_bucket_acl" "secure_bucket_acl_2" {
  bucket = aws_s3_bucket.mybucket_2.id
  acl    = "private"
}

resource "aws_s3_bucket_acl" "secure_bucket_acl_3" {
